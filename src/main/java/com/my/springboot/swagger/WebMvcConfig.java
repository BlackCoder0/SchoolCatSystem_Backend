...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public void createFileToDisk() {
        ...
        if (dest != null) {
            ...
            System.out.println("---------资料目录创建成功 位置----------" + windowsResourcesPath);
            System.out.println("---------资料访问方法--- http://localhost:端口号/static/xxx.jpg -------");
            System.out.println("---------资料访问方法如--- http://localhost:8888/static/test.bmp -------");
